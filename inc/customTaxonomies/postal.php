...
add_action('init', function (): void {
    $labels = [
        'name'                       => _x('Postal Code', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Postal Code', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Postal Codes', 'flynt'),
        'all_items'                  => __('All Postal Codes', 'flynt'),
        'parent_item'                => __('Parent Item', 'flynt'),
        'parent_item_colon'          => __('Parent Item:', 'flynt'),
        'new_item_name'              => __('New Postal Code', 'flynt'),
        'add_new_item'               => __('Add New Postal Code', 'flynt'),
    ...
    register_taxonomy('postal', ['locations'], $args);
});
