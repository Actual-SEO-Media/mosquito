...
add_action('init', function (): void {
    $labels = [
        'name'                       => _x('Areas', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Area', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Areas', 'flynt'),
        'all_items'                  => __('All Areas', 'flynt'),
    ...
    register_taxonomy('area', ['locations'], $args);
});